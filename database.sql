...
--
-- Host: localhost:3306
-- Gegenereerd op: 14 jun 2018 om 19:40
-- Serverversie: 5.6.35
-- PHP-versie: 7.1.8
...
('jeffrey', 'Jeffrey', 'van', 'Rossum', 'Juliana van Stolberglaan', 53, '6713PB', 'Ede', 'rossum.jeffrey@gmail.com', 'm', 'test123'),
('jurrian', 'Jurrian', 'te', 'Loo', 'test', 1, '1234AB', 'Apeldoorn', 'jurrian@test.nl', 'm', 'test123');
...
--
-- Gegevens worden geëxporteerd voor tabel `PRODUCT_GERELATEERD_PRODUCT`
--
